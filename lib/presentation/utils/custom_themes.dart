...
class CustomPieceSets {
  static final animals = PieceSet.text(
    strings: {
      ...
      'q': '🐯',
      'k':
          '🦁', // Black (same for text in this theme, though normally different style, but let's add visual change maybe? Or just keep it as emojis. Emojis don't have color easily)
    },
